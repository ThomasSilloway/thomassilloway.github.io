...
! function(t) {
            ...
            case K:
                return function(t, e, n, r, i) {
                    var o = Ct.map(function(t) {
                        ...
                        a = i.setStyle;
                    Dt(t, g.TRANSFORM_PREFIXED, i), a(t, g.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === J && void 0 !== d || s === tt && void 0 !== d || s === et && (void 0 !== f || void 0 !== l)) && a(t, g.TRANSFORM_STYLE_PREFIXED, R);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case q:
    ...
    }, e.getMaxDurationItemIndex = kt, e.getActionListProgress = function(t, e) {
    ...
    function mt(t) {
        ...
        return null == x || null == C ? [] : g.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : N === G ? d(x, C) : N === X ? p(d(x)).filter(E(C)) : N === k ? h(d(x)).filter(E(C)) : d(C)
    }
    var It = /px/,
        Tt = function(t, e) {
    ...
    "events": {
        "e-5": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "63a24eeb3ae536a8318be2d3|667fb1a8-3798-7742-404d-7b613ef106a3"
            },
            "targets": [],
            "config": {
                "loop": false,
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "63a24eeb3ae536a8318be2d3|8fda824e-9cf9-bdaf-818b-ca08b0c90837"
                        },
                        "xUnit": "PX",
                        "yUnit": "PX",
                        "zUnit": "PX"
