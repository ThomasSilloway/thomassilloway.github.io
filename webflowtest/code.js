...
! function(t) {
    ...
    i.resize = E(u, _), i.scroll = E(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = E(), i.location = function(t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, v), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === k.state() && A()
    ...
    window.tram = function(t) {
        ...
        if ($.transition) {
            var j = $.timing.dom;
            if (S.style[j] = f["ease-in-back"][0], !S.style[j])
                for (var O in d) f[O][0] = d[O]
        }
        var F = e.frame = function() {
            ...
            q = l(function(e) {
                ...
                e.init = function(e) {
                    ...
                    $.backface && H.hideBackface && X(this.el, $.backface.css, "hidden")
            ...
            U = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (F(n), e = C(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = C()), this.active = !0, t = this, 1 === u.push(t) && F(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        e.fallback = function(t) {
            if (!$.transition) return H.fallback = !0;
            H.agentTests.push("(" + t + ")");
        ...
        $.transform && (Y.transform = [R], Z = {
            ...
            skewX: [k],
            skewY: [k]
        }), $.transform && $.backface && (Z.z = [x, "translateZ"], Z.rotateZ = [k], Z.scaleZ = [b], Z.perspective = [y]);
        var J = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
            ...
            r.done = a.find("> .w-form-done"), r.fail = a.find("> .w-form-fail"), r.fileUploads = a.find(".w-file-upload"), r.fileUploads.each(function(e) {
                ! function(e, n) {
                    ...
                    w || f.on("click keydown", function(t) {
                        "keydown" === t.type && 13 !== t.which && 32 !== t.which || (t.preventDefault(), l.click())
                    });
                    if (f.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), m.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), w) l.on("click", function(t) {
                        t.preventDefault()
                        ...
                        m.on("click keydown", function(t) {
                            ...
                            l.removeAttr("data-value"), l.val(""), v.html(""), o.toggle(!0), s.toggle(!1), f.focus()
                        }), l.on("change", function(r) {
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), a.focus(), v.text(i.name), S() || k(n), n.fileUploads[e].uploading = !0, function(e, n) {
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = g : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = b), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), c.focus(), n.fileUploads[e].uploading = !1, S() || x(n)
                    }
                    ...
                    function A(t) {
                        if (t) return E(t);
                        a.toggle(!1), s.css("display", "inline-block"), s.focus(), n.fileUploads[e].uploading = !1, S() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), b.test(c) ? r.handler = A : c || (o ? r.handler = L : g())
        }
        ...
        function _(e, n) {
            ...
            return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])').each(function(r, o) {
                ...
                "string" == typeof c && (c = t.trim(c)), n[u] = c, i = i || function(t, e, n, i) {
                    var r = null;
                    "password" === e ? r = "Passwords cannot be submitted." : t.attr("required") ? i ? p.test(t.attr("type")) && (m.test(i) || (r = "Please enter a valid email address for: " + n)) : r = "Please fill out the required field: " + n : "g-recaptcha-response" !== n || i || (r = "Please confirm youâ€™re not a robot.");
                    return r
                }(a, s, u, c)
            }), i
        }
        c.ready = c.design = c.preview = function() {
            ! function() {
                o = t("html").attr("data-wf-site"), s = "https://webflow.com/api/v1/form/" + o, d && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "https://formdata.webflow.com"));
